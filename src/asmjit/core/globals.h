...
static inline tsjitFunc ptr_as_func(void* func) noexcept { return Support::ptr_cast_impl<tsjitFunc, void*>(func); }

template<typename tsjitFunc>
static inline void* func_as_ptr(tsjitFunc func) noexcept { return Support::ptr_cast_impl<void*, tsjitFunc>(func); }
